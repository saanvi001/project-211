...
tanjiro_3Img= loadImage("assets/tanjiro_2.png");
 ...
 ruiImg = loadImage("assets/ALIEN0.JPEG");
}
...
function enemy(){
  ...
  if(frameCount%50===0){
    ...
    rui = createSprite(random(500,1000),random(100,500),40,40)  
    rui.addImage(ruiImg)
   rui.scale = 0.1
    rui.velocityX = -3
    rui.debug= true
    rui.setCollider("rectangle",0,0,400,400)
